...
class MovingMNIST(data.Dataset):
    def __init__(self, configs, root, is_train, n_frames, num_objects,
                 transform=None):
        '''
    ...
    def __getitem__(self, idx):
        ...
        images = preprocess.reshape_patch(images, self.configs.patch_size).transpose(0,3,1,2)
        # print(images.shape)

        # output = images[:self.n_frames]
